        ...
        <div className="login-container">
            ...
            <div className="banner">
                <div className="banner-content">
                    <svg width="292" height="189" viewBox="0 0 292 189" fill="none" xmlns="http://www.w3.org/2000/svg" className="logo-svg">
                        <path fillRule="evenodd" clipRule="evenodd" className="logo-path"
