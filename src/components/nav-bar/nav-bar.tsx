...
const navLinks = [
    ...
    },
    {
        name: 'Sandbox',
        link: '/sandbox',
        iconElement: (fillColor: string) => <svg width="1em" height="1em" viewBox="0 0 32 36" fill="none"
        ...
        <div className="navigation-area">
            <div className="navigation-bar">
                ...
                <ul>
                    <li key="sign-out">
                        <Link href="#">
                            <svg width="25" height="25" viewBox="0 0 30 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke="#BAC5D1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path
