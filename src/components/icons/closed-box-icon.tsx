...
export const ClosedBoxIcon = ({ width = 64, height = 64, className }: ClosedBoxIconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <path d="M17.4551 23.3801L32.2111 31.916L46.9671 23.3801" stroke="currentColor" strokeWidth="2"
                strokeLinecap="round" strokeLinejoin="round" />
            <path d="M32.2117 48.9371V31.8992" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                strokeLinejoin="round" />
        </svg>
    );
};
