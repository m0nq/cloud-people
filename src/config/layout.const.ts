...
export const DEFAULT_CONTAINER_HEIGHT = 938;
export const DEFAULT_CONTAINER_WIDTH = 1680;
...
export const ROOT_NODE_POSITION = { x: 200, y: DEFAULT_CONTAINER_HEIGHT * 0.5 };
