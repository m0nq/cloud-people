...
import { ArrowRight, Book, Briefcase, List, MoreVertical, Pause, Settings2, Users } from 'lucide-react';
import {
    closestCenter,
    DndContext,
    DragEndEvent,
...
import { Category, useCategoriesStore } from '../store/categories';
                            ...
                            <DndContext sensors={sensors}
                                ...
                                <SortableContext
                                    ...
                                    {categories.map((category) => {
                                        ...
                                        return (
                                            <div key={category.id} className="draggable-category space-y-4">
                                                ...
                                                <div ref={(el) => scrollContainerRefs.current[category.id] = el}
                                                    className="category-card-container flex overflow-x-auto pb-4 space-x-4 scrollbar-hide"
                                                    style={{
                                                        scrollbarWidth: 'none',
                                                    ...
                                                    {categoryProjects.map((project) => (
                                                        <div key={project.id}
                                                            className="project-card-container flex-shrink-0 w-[320px]">
