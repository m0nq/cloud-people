          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {error && (
              <div className={`rounded-md ${isDarkMode ? 'bg-red-900' : 'bg-red-50'} p-4`}>
                <div className="flex">
                  <div className="ml-3">
                    <h3 className={`text-sm font-medium ${isDarkMode ? 'text-red-200' : 'text-red-800'}`}>{error}</h3>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <input
                  ...
                  className={`appearance-none block w-full px-3 py-2 border ${
                    isDarkMode 
                      ? 'border-gray-600 bg-gray-800 text-white placeholder-gray-500 focus:ring-blue-500 focus:border-blue-500' 
